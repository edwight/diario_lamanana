        ...
        <div class="col-md-10 col-md-offset-1">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    @endif
                    {{ Form::open(['action' =>'AdminController@store','class'=>'form-horizontal','role'=>'form', 'files' => true])}}
                        <div class="form-group">
                        {{Form::label('subtitulo', 'SubTitulo', array('class' => 'col-md-2 control-label')) }}
                        <div class="col-md-10">
                            {{Form::text('subtitulo', null,['class'=>'form-control','name'=>'subtitulo','placeholder'=>'Ante Titulo'] )}}
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-10">
                            {{Form::text('titulo', null,['class'=>'form-control','name'=>'titulo','placeholder'=>'Titulo'] )}}
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-10">
                            {{Form::textarea('contenido', null,['class'=>'edit','name'=>'contenido'] )}}
                        </div>
                    </div>
